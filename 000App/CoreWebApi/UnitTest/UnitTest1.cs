...
namespace UnitTest
{
    ...
    {
        [Fact]
        public void AddCartProductReturnsProduct()
        {
            var get = 1;
            Assert.Equal(1, get);
        }
        ...
        [Fact]
        public void GetUserFridgesReturnFridge()
        {
            var get = 1;
            Assert.Equal(1, get);
        }
        [Fact]
        public void UpdateCartProductReturnsProduct()
        {
            var get = 1;
            Assert.Equal(1, get);
        }
        [Fact]
        public void AddFridgeProductReturnsProduct()
        {
            var get = 1;
            Assert.Equal(1, get);
