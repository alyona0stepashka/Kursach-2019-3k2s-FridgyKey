...
namespace FK.BLL.Interfaces
{
    public interface IStickerService
    {
        ...
        IEnumerable<Sticker> SearchByWord(string word);  //найти все записи, в которых есть это слово
        IEnumerable<Sticker> SearchByWord(string word, int? user_id);  //найти записи этого юзера, в которых есть это слово
